...
-   [x] Media queries for larger screens (refactor into single ones with categories)
-   [x] Viewport meta tag ensures page loads zoomed out
-   [x] Recent Posts roll sized appropriately for small screens

### User Experience

-   [x] Make sure text sizes and elements suitably scale dynamically for all resolutions
